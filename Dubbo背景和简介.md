...
![Alt text](images/1492160801203.png)
2. 垂直应用框架(MVC)
	垂直应用架构解决了单一应用架构所面临的扩容问题，流量能够分散到各个子系统当中，且系统的体积可控，一定程度上降低了开发人员之间协同以及维护的成本，提升了开发效率。
	**缺点**：但是在垂直架构中相同逻辑代码需要不断的复制，不能复用。
![Alt text](images/1492161321884.png)

3. 分布式应用架构(RPC)
	当垂直应用越来越多，应用之间交互不可避免，将核心业务抽取出来，作为独立的服务，逐渐形成稳定的服务中心
![Alt text](images/1492161354130.png)

4.  流动计算架构(SOA)
随着服务化的进一步发展，服务越来越多，服务之间的调用和依赖关系也越来越复杂，诞生了面向服务的架构体系(SOA)，也因此衍生出了一系列相应的技术，如对服务提供、服务调用、连接处理、通信协议、序列化方式、服务发现、服务路由、日志输出等行为进行封装的服务框架

从以上是电商系统的演变可以看出架构演变的过程：
![Alt text](images/1492161516588.png)
* 单一应用架构
...
![Alt text](images/1492174028390.png)
...
###Dubbo架构
![Alt text](images/1492174975573.png)
...
![Alt text](images/1492175831002.png)
...
![Alt text](images/1492408015354.png)
...
![Alt text](images/1492408198605.png)
...
需加入公共接口所在的依赖
![Alt text](images/1492409216786.png)
...
运行提供者：
![Alt text](images/1492422470086.png)
消费者成功调用提供者所提供的远程服务：
![Alt text](images/1492422491491.png)
...
![Alt text](images/1492422639610.png)
...
查看提供者：
![Alt text](images/1492422912493.png)
查看消费者：
![Alt text](images/1492422960059.png)
